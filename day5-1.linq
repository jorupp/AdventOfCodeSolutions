...
var doubles = "qwertyuiopasdfghjklzxcvbnm".Select(i => new string(i, 2)).ToArray();
foreach(var line in inputs.Split('\n')) {
	if(line.Contains("ab") || line.Contains("cd") || line.Contains("pq") || line.Contains("xy")) {
		continue;
	}
	if(vowels.Matches(line).Count < 3) {
		continue;
	}
	if(doubles.Any(i => line.Contains(i))) {
		nice++;
	}
}
nice.Dump();