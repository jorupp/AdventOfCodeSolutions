...
Enumerable.Range(0, int.MaxValue).AsParallel().Select(i => new { i = i, hash = hasher.Value.ComputeHash(Encoding.ASCII.GetBytes(prefix + i))}).Where(i => i.hash[0] == 0 && i.hash[1] == 0 && i.hash[2] == 0).First().Dump();